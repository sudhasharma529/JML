...
switch lower(metadata.stim.type)
    ...
    case 'puff2'
        stfrm=round(metadata.cam_eye_2.time(1)./1000.*metadata.cam_eye_2.fps);
        enfrm=round(metadata.stim.totaltime./1000.*metadata.cam_eye_2.fps);
        stim=zeros(m,n,3,t,'uint8');
        stim(box_x,box_y,2,stfrm:stfrm+enfrm)=255;    
    case 'electrical'       
...
%set(writeObj,'FrameRate',fr); %The maximum value the the frame rate is
%172. We can fix this parameter to whatever value smaller than 173
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
set(writeObj,'FrameRate',100);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
open(writeObj);
